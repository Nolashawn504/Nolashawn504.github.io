$(function () {
  ...
  function setup() {
    ...
    createCollectable("steve",500,300,200,20); //creates a "steve" collectible at the coordinates(500,300,200,20,)falling with default gravity and bouncing with default bounce 
